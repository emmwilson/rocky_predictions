...
#| include: false
  ...
  # rocky_river$D50f <- factor(sort(rocky_river$D50))
  # 
  # D50_colors <- function(x) {ifelse(64 <= x, colorNumeric(c("#e9c602", "white"), domain = c(64, max(rocky_river$D50)), na.color = "transparent")(x), ifelse(x <= 16, colorNumeric(c("white", "#e9c602"), domain = c(0, 16), na.color = "transparent")(x), "#0E7329"))}
  # 
  # D50.pal <- colorFactor(D50_colors(sort(rocky_river$D50)), domain = rocky_river$D50, na.color = "transparent")  
